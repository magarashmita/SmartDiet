...
# Login form/User Authentication has been added to the existing Zakaria-Narjis's Diet Recommendation System #
Simple Home page named SmartDiet, About Us and Contact is created in Streamlit.
Cloned from: https://github.com/zakaria-narjis/Diet-Recommendation-System.git
Modified for personal educational purpose. Besides the work that is added mentioned above to this recommendation system, all other works are from Zakaria-Narjis.

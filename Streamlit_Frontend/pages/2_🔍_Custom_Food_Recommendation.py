...
hide_bar = """
    <style>
    /* hide all pages except home and second page */
    [data-testid="stSidebar"][aria-expanded="true"] > div:first-child > div > div:not(:nth-child(2)):not(:nth-child(3)) {
        visibility: hidden;
        width: 0px;
    }
    /* show home and second page */
    [data-testid="stSidebar"][aria-expanded="true"] > div:first-child > div > div:nth-child(2), [data-testid="stSidebar"][aria-expanded="true"] > div:first-child > div > div:nth-child(3) {
        visibility: visible;
    }
    /* hide all pages except home and second page when sidebar is collapsed */
    [data-testid="stSidebar"][aria-expanded="false"] > div:first-child > div > div:not(:nth-child(2)):not(:nth-child(3)) {
        visibility: hidden;
    }
    /* show home and second page when sidebar is collapsed */
    [data-testid="stSidebar"][aria-expanded="false"] > div:first-child > div > div:nth-child(2), [data-testid="stSidebar"][aria-expanded="false"] > div:first-child > div > div:nth-child(3) {
        visibility: visible;
    }
    </style>
"""
...
# --- USER AUTHENTICATION ---
names = ["ashmita","rinu","neha"]
usernames = ["ashmita","rinu","neha"]
